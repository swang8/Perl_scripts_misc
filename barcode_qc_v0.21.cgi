...
# qw(Sample Project Barcode_number  Barcode_id  i7  i5  Barcode_source);
    ...
    print $OUT "</div>";
    print $OUT "<br>";
    print $OUT "<div><strong>Error count: </strong><li>Index number error :  ",  add_color($num_error), "</li><li> i7 seq error :  ", add_color($i7_error), "</li><li>i5 seq error :  ", add_color($i5_error), "</li></div>\n";
    print $OUT "<hr>\n";
    print $OUT "<strong>Barcode  pairwise distance table</strong>";
    ...
    if (@conflicts){
        print $OUT "<h4><a style=\"color : red\">There are incompatible barcodes detected!!" , (scalar @conflicts > 10?" A lot!" : ""),   "</a><h4><br>\n";
    }
    else {
   ...
   # d)		Output check 1
    ...
    print $OUT "<p><h4><strong>Error list : </strong></h4></p>\n";
    print $OUT "<pre>\n";
    ...
    print $OUT "<h3>The original input file (with incompatible ones colored in red) :</h3>";
