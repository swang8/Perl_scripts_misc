...
##
# predefined 
my $bamutil = "/homes/wangsc/Tools/bamUtil-master/bin/bam ";
check_exec($bamutil);
my $samtools_bin = "/homes/wangsc/Tools/samtools/samtools ";
check_exec($samtools_bin);
#my $samtools_bin = "samtools ";
my $picard_dir  = "/homes/wangsc/Tools/picard";
my $GATK_jar = "/homes/wangsc/Tools/GATK/GenomeAnalysisTK.jar ";
