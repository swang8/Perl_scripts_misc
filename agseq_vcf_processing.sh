...
Rscript ~/pl_scripts/histogram.R  -i Missing_rate.txt -e 1 -t "SNP missing rate" -s "No imputation" -x "Missing rate"

Rscript ~/pl_scripts/histogram.R  -i sample_missing.txt -e 0 -t "Sample missing rate" -s "No imputation" -x "Missing rate"
...
Rscript ~/pl_scripts/histogram.R  -i GP_0.9.Missing_rate.txt -e 1 -t "SNP missing rate" -s "Imputed and filtered with GP>=0.9" -x "Missing rate"
Rscript ~/pl_scripts/histogram.R  -i GP_0.8.Missing_rate.txt -e 1 -t "SNP missing rate" -s "Imputed and filtered with GP>=0.8" -x "Missing rate"

Rscript ~/pl_scripts/histogram.R  -i GP_0.9_sample_missing.txt -e 0 -t "Sample missing rate" -s  "Imputed and filtered with GP>=0.9" -x "Missing rate"
Rscript ~/pl_scripts/histogram.R  -i GP_0.8_sample_missing.txt -e 0 -t "Sample missing rate" -s  "Imputed and filtered with GP>=0.8" -x "Missing rate"
